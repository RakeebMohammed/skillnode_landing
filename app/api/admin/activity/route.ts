...
const visibleActivityMatch = { $or: [{ type: { $ne: "click" } }, { "metadata.placement": { $in: ["header", "footer"] } }] };
...
export async function GET(request: NextRequest) {
  try {
    ...
    const eventMatch: Record<string, unknown> = { ...visibleActivityMatch };
