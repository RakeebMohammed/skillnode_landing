...
const tooltip = { backgroundColor: "#13221b", titleColor: "#fff", bodyColor: "#d9efe2", padding: 12, cornerRadius: 10, displayColors: false, titleFont: { weight: 700 }, bodyFont: { weight: 600 } };
